...
,borderRadius:"5px",backgroundColor:"var(--primary)"}} className="mx-4" onClick={()=>html2pdf().from(document.getElementById(`jsx-template${index}`)).save("stockIssueReport.pdf")}>print</button>
 <hr />
 </>
